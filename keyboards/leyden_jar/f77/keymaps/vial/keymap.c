...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LSFT, KC_NUBS,KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT,    KC_P0,   KC_UP,   KC_PDOT,
        KC_LCTL,  KC_LGUI, KC_LALT,                     KC_SPC,              KC_NO, KC_RALT, KC_NUM,  MO(_FN),    KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_INS, KC_DEL,           KC_HOME,   KC_UP,   KC_PGUP,
        KC_NO, HF_ON,  HF_OFF,  HF_TOGG, HF_RST,  HF_DWLD,  HF_DWLU,  KC_NO, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP, KC_NO, KC_DEL,         KC_LEFT,   KC_NO,   KC_RIGHT,
