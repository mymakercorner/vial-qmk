...
#define VIAL_KEYBOARD_UID {0x01, 0x44, 0x46, 0x4D, 0x04, 0x47, 0x09, 0x12}
/* USB Device descriptor parameter */
#define VENDOR_ID 0x1209
#define PRODUCT_ID 0x4704
#define DEVICE_VER 0x4401
#define MANUFACTURER Model F Labs LLC
#define PRODUCT FSSKr2 Keyboard (FW:r5)
#define DESCRIPTION FSSKr2 keyboard by Model F Labs LLC (FW:r5)
...
// Note: physical column are 16, but only 15 (fssk new) are ever used. Column 0..9 match the physical column. Column 10 is physical column 15.
