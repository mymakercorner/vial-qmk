...
#define VIAL_KEYBOARD_UID {0x01, 0x22, 0x53, 0x42, 0x04, 0x47, 0x09, 0x12}
/* USB Device descriptor parameter */
#define VENDOR_ID 0x1209
#define PRODUCT_ID 0x4704
#define DEVICE_VER 0x2201
#define MANUFACTURER Model F Labs LLC
#define PRODUCT BSSK Keyboard (FW:r5)
#define DESCRIPTION BSSK keyboard by Model F Labs LLC (FW:r5)
