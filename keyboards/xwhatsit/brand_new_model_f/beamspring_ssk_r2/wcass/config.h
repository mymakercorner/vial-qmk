...
#define VIAL_KEYBOARD_UID {0x01, 0x23, 0x53, 0x42, 0x04, 0x47, 0x09, 0x12}
/* USB Device descriptor parameter */
#define VENDOR_ID 0x1209
#define PRODUCT_ID 0x4704
#define DEVICE_VER 0x2301
#define MANUFACTURER Model F Labs LLC
#define PRODUCT BSSKr2 Keyboard (FW:r5)
#define DESCRIPTION BSSKr2 keyboard by Model F Labs LLC (FW:r5)
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) ((col >= 14)?(col + 1):(col))
