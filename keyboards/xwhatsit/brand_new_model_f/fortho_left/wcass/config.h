...
#define VIAL_KEYBOARD_UID {0x01, 0x47, 0x46, 0x4D, 0x04, 0x47, 0x09, 0x12}
/* USB Device descriptor parameter */
#define VENDOR_ID 0x1209
#define PRODUCT_ID 0x4704
#define DEVICE_VER 0x4701
#define MANUFACTURER Model F Labs LLC
#define PRODUCT FOrtho-L Keyboard (FW:r5)
#define DESCRIPTION FOrtho-L keyboard by Model F Labs LLC (FW:r5)
...
#define CAPSENSE_KEYMAP_COL_TO_PHYSICAL_COL(col) ((col >= 4)?(col + 8):((col >= 3)?(col + 7):((col >= 2)?(col + 1):(col))))
