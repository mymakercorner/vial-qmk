...
#define VIAL_KEYBOARD_UID {0x01, 0x05, 0x04, 0x47, 0x04, 0x47, 0x09, 0x12}
/* USB Device descriptor parameter */
#define VENDOR_ID 0x1209
#define PRODUCT_ID 0x4704
#define DEVICE_VER 0x0501
#define MANUFACTURER Model F Labs LLC
#define PRODUCT F50 Keyboard (FW:r5)
#define DESCRIPTION F50 keyboard by Model F Labs LLC (FW:r5)
